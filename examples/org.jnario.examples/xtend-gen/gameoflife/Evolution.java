...
public class Evolution {
  ...
  public World evolve(final World world) {
    ...
    final Function1<CellLocation, Boolean> _function = (CellLocation it) -> {
      Rule _staysAlive = this.getStaysAlive();
      return Boolean.valueOf(this.apply(_staysAlive, world, it));
    };
    ...
    final Function1<CellLocation, Boolean> _function_1 = (CellLocation it) -> {
      Rule _becomesAlive = this.getBecomesAlive();
      return Boolean.valueOf(this.apply(_becomesAlive, world, it));
    };

		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTypeAccess().getPreambleAssignment_2_1(), "rule__Type__PreambleAssignment_2_1");
					put(grammarAccess.getTypeAccess().getTargetTypeAssignment_2_2(), "rule__Type__TargetTypeAssignment_2_2");
					put(grammarAccess.getTypeAccess().getNameAssignment_2_3(), "rule__Type__NameAssignment_2_3");
					put(grammarAccess.getTypeAccess().getMembersAssignment_2_5(), "rule__Type__MembersAssignment_2_5");
					...
					put(grammarAccess.getMemberAccess().getNameAssignment_2_7_5_0_0_1(), "rule__Member__NameAssignment_2_7_5_0_0_1");
					put(grammarAccess.getMemberAccess().getNameAssignment_2_7_5_1_0(), "rule__Member__NameAssignment_2_7_5_1_0");

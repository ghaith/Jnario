...
public class SpecGrammarAccess extends AbstractGrammarElementFinder {
	...
	public SpecGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tCOMMENT_RICH_TEXT_INBETWEEN = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.jnario.spec.Spec.COMMENT_RICH_TEXT_INBETWEEN");
		this.tCOMMENT_RICH_TEXT_END = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.jnario.spec.Spec.COMMENT_RICH_TEXT_END");

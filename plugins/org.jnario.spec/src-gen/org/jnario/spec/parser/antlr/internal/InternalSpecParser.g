		...
		}
		{
	        if ($current==null) {
       		...
       		setWithLastConsumed(
       			...
       			"value",
        		lv_value_2_0, 
        		"org.jnario.spec.Spec.COMMENT_RICH_TEXT_INBETWEEN");
	    }
		...
		}
		{
	        if ($current==null) {
       		...
       		setWithLastConsumed(
       			...
       			"value",
        		lv_value_2_0, 
        		"org.jnario.spec.Spec.COMMENT_RICH_TEXT_END");
	    }

...
RULE_RICH_TEXT_START : '\'\'\'' RULE_IN_RICH_STRING* ('\'' '\''?)? '\u00C2\u00AB';

RULE_RICH_TEXT_END : '\u00C2\u00BB' RULE_IN_RICH_STRING* ('\'\'\''|('\'' '\''?)? EOF);

RULE_RICH_TEXT_INBETWEEN : '\u00C2\u00BB' RULE_IN_RICH_STRING* ('\'' '\''?)? '\u00C2\u00AB';

RULE_COMMENT_RICH_TEXT_INBETWEEN : '\u00C2\u00AB\u00C2\u00AB' ~(('\n'|'\r'))* ('\r'? '\n' RULE_IN_RICH_STRING* ('\'' '\''?)? '\u00C2\u00AB')?;

RULE_COMMENT_RICH_TEXT_END : '\u00C2\u00AB\u00C2\u00AB' ~(('\n'|'\r'))* ('\r'? '\n' RULE_IN_RICH_STRING* ('\'\'\''|('\'' '\''?)? EOF)|EOF);

fragment RULE_IN_RICH_STRING : ('\'\'' ~(('\u00C2\u00AB'|'\''))|'\'' ~(('\u00C2\u00AB'|'\''))|~(('\u00C2\u00AB'|'\'')));

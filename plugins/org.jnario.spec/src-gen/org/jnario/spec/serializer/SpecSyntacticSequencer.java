...
public class SpecSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_Member_EachKeyword_2_2_1_1_1_q.equals(syntax))
	 ...
	 *     {Before.annotationInfo=} 'before' (ambiguity) expression=XExpression
	 *     {Before.annotationInfo=} 'before' (ambiguity) name=STRING
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     {After.annotationInfo=} 'after' (ambiguity) expression=XExpression
	 *     {After.annotationInfo=} 'after' (ambiguity) name=STRING
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     pending?='pending' (ambiguity) expr=XExpression
	 *     {Example.annotationInfo=} (ambiguity) expr=XExpression
	 */
	 ...
	 *     {ExampleTable.annotationInfo=} 'def' '{' (ambiguity) '}' (rule end)
	 */

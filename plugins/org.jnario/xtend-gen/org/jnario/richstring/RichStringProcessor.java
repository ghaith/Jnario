...
public class RichStringProcessor {
  public static class RichStringAcceptor {
    private List<BiConsumer<ITreeAppendable, String>> toBeAppended = CollectionLiterals.<BiConsumer<ITreeAppendable, String>>newArrayList();
    ...
    protected Boolean _accept(final XBlockExpression block) {
      final BiConsumer<ITreeAppendable, String> _function = new BiConsumer<ITreeAppendable, String>() {
        @Override
        public void accept(final ITreeAppendable appendable, final String variableName) {
    ...
    protected Boolean _accept(final XExpression literal) {
      final BiConsumer<ITreeAppendable, String> _function = new BiConsumer<ITreeAppendable, String>() {
        @Override
        public void accept(final ITreeAppendable appendable, final String name) {
          StringConcatenation _builder = new StringConcatenation();
    ...
    protected Boolean _accept(final EObject obj) {
      final BiConsumer<ITreeAppendable, String> _function = new BiConsumer<ITreeAppendable, String>() {
        @Override
        public void accept(final ITreeAppendable appendable, final String variableName) {
          StringConcatenation _builder = new StringConcatenation();
          _builder.append(variableName, "");
          _builder.append(".append(");
          _builder.append("\"A nice String, greetings from Ghaith and Mathias\"");
          _builder.append(");");
          appendable.append(_builder);
          appendable.newLine();
        }
    ...
    public void appendTo(final ITreeAppendable appendable, final String variableName) {
      final Consumer<BiConsumer<ITreeAppendable, String>> _function = new Consumer<BiConsumer<ITreeAppendable, String>>() {
        @Override
        public void accept(final BiConsumer<ITreeAppendable, String> it) {
    ...
    public Boolean accept(final EObject literal) {
      ...
      } else if (literal instanceof XExpression) {
        return _accept((XExpression)literal);

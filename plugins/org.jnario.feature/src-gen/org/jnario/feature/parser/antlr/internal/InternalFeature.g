		...
		lv_xtendTypes_4_0=ruleFeature		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"xtendTypes",
        		lv_xtendTypes_4_0, 
        		"org.jnario.feature.Feature.Feature");
	        afterParserOrEnumRuleCall();
	    }
		...
		}
		{
	        if ($current==null) {
       		...
       		setWithLastConsumed(
       			...
       			"name",
        		lv_name_2_0, 
        		"org.jnario.feature.Feature.FEATURE_TEXT");
	    }
		...
		}
		{
	        if ($current==null) {
       		...
       		setWithLastConsumed(
       			...
       			"description",
        		lv_description_3_0, 
        		"org.jnario.feature.Feature.TEXT");
	    }
		...
		lv_members_4_0=ruleBackground		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"members",
        		lv_members_4_0, 
        		"org.jnario.feature.Feature.Background");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_members_5_0=ruleScenario		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"members",
        		lv_members_5_0, 
        		"org.jnario.feature.Feature.Scenario");
	        afterParserOrEnumRuleCall();
	    }
		...
		}
		{
	        if ($current==null) {
       		...
       		setWithLastConsumed(
       			...
       			"name",
        		lv_name_1_0, 
        		"org.jnario.feature.Feature.BACKGROUND_TEXT");
	    }
		...
		lv_members_2_0=ruleMember		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"members",
        		lv_members_2_0, 
        		"org.jnario.feature.Feature.Member");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_members_3_1=ruleGiven		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"members",
        		lv_members_3_1, 
        		"org.jnario.feature.Feature.Given");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_members_3_2=ruleGivenReference		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"members",
        		lv_members_3_2, 
        		"org.jnario.feature.Feature.GivenReference");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_members_4_1=ruleAnd		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"members",
        		lv_members_4_1, 
        		"org.jnario.feature.Feature.And");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_members_4_2=ruleAndReference		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"members",
        		lv_members_4_2, 
        		"org.jnario.feature.Feature.AndReference");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_members_4_3=ruleBut		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"members",
        		lv_members_4_3, 
        		"org.jnario.feature.Feature.But");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_members_4_4=ruleButReference		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"members",
        		lv_members_4_4, 
        		"org.jnario.feature.Feature.ButReference");
	        afterParserOrEnumRuleCall();
	    }
		...
		}
		{
	        if ($current==null) {
       		...
       		setWithLastConsumed(
       			...
       			"name",
        		lv_name_1_0, 
        		"org.jnario.feature.Feature.SCENARIO_TEXT");
	    }
		...
		lv_members_5_1=ruleWhen		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"members",
        		lv_members_5_1, 
        		"org.jnario.feature.Feature.When");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_members_5_2=ruleWhenReference		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"members",
        		lv_members_5_2, 
        		"org.jnario.feature.Feature.WhenReference");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_members_7_1=ruleThen		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"members",
        		lv_members_7_1, 
        		"org.jnario.feature.Feature.Then");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_members_7_2=ruleThenReference		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"members",
        		lv_members_7_2, 
        		"org.jnario.feature.Feature.ThenReference");
	        afterParserOrEnumRuleCall();
	    }
...
(
...
)*((
    {
        $current = forceCreateModelElementAndSet(
            grammarAccess.getMemberAccess().getJnarioFieldAnnotationInfoAction_2_0(),
            $current);
    }
)(
(
		...
		lv_modifiers_3_0=ruleCommonModifier		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"modifiers",
        		lv_modifiers_3_0, 
        		"org.jnario.feature.Feature.CommonModifier");
	        afterParserOrEnumRuleCall();
	    }
		...
		lv_modifiers_4_0=ruleFieldModifier		{
	        if ($current==null) {
       		...
       		add(
       			...
       			"modifiers",
        		lv_modifiers_4_0, 
        		"org.jnario.feature.Feature.FieldModifier");
	        afterParserOrEnumRuleCall();
	    }
		...
		}
		{
	        if ($current==null) {
       		...
       		setWithLastConsumed(
       			...
       			"name",
        		lv_name_1_0, 
        		"org.jnario.feature.Feature.GIVEN_TEXT");
	    }
		...
		lv_expression_2_0=ruleBlockExpression		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"expression",
        		lv_expression_2_0, 
        		"org.jnario.feature.Feature.BlockExpression");
	        afterParserOrEnumRuleCall();
	    }
		...
		}
		{
	        if ($current==null) {
       		...
       		setWithLastConsumed(
       			...
       			"name",
        		lv_name_1_0, 
        		"org.jnario.feature.Feature.WHEN_TEXT");
	    }
		...
		}
		{
	        if ($current==null) {
       		...
       		setWithLastConsumed(
       			...
       			"name",
        		lv_name_1_0, 
        		"org.jnario.feature.Feature.THEN_TEXT");
	    }
		...
		}
		{
	        if ($current==null) {
       		...
       		setWithLastConsumed(
       			...
       			"name",
        		lv_name_1_0, 
        		"org.jnario.feature.Feature.AND_TEXT");
	    }
		...
		}
		{
	        if ($current==null) {
       		...
       		setWithLastConsumed(
       			...
       			"name",
        		lv_name_1_0, 
        		"org.jnario.feature.Feature.BUT_TEXT");
	    }
		...
		lv_rightOperand_3_0=ruleXRelationalExpression		{
	        if ($current==null) {
       		...
       		set(
       			...
       			"rightOperand",
        		lv_rightOperand_3_0, 
        		"org.jnario.feature.Feature.XRelationalExpression");
	        afterParserOrEnumRuleCall();
	    }
		...
		}
		{
	        if ($current==null) {
       		...
       		setWithLastConsumed(
       			...
       			"value",
        		lv_value_1_0, 
        		"org.jnario.feature.Feature.STRING");
	    }
...
RULE_STRING : (RULE_RICH_TEXT|'"' ('\\' .|~(('\\'|'"')))* '"'?|'\'' ('\\' .|~(('\\'|'\'')))* '\''?);

fragment RULE_RICH_TEXT : '\'\'\'' RULE_IN_RICH_STRING* ('\'\'\''|('\'' '\''?)? EOF);

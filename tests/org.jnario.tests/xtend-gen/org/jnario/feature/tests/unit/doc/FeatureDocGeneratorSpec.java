...
public class FeatureDocGeneratorSpec {
  ...
  public void _generatesScenarioDocumentation() throws Exception {
    ...
    _builder.append("<ul>");
    _builder.newLine();
    _builder.append("<li><span class=\"step notrun\"><p>Given a step with an argument <code>&quot;something&quot;</code>, another <code>&quot;argument&quot;</code> and a multiline string:</p>");
    _builder.newLine();
    _builder.append("<pre>import java.util.Collections.*;");
    _builder.newLine();
    _builder.newLine();
    ...
    _builder.append("</li>");
    _builder.newLine();
    _builder.append("<li><span class=\"step pending\"><p>When I do something that is pending. [PENDING]</p>");
    _builder.newLine();
    _builder.append("</span>");
    _builder.newLine();
    _builder.append("</li>");
    _builder.newLine();
    _builder.append("<li><span class=\"step pending\"><p>And something else that is pending [PENDING]</p>");
    _builder.newLine();
    _builder.append("</span>");
    _builder.newLine();
    _builder.append("</li>");
    _builder.newLine();
    _builder.append("<li><span class=\"step notrun\"><p>But this is implemented</p>");
    _builder.newLine();
    _builder.append("</span>");
    _builder.newLine();
    _builder.append("</li>");
    _builder.newLine();
    _builder.append("<li><span class=\"step notrun\"><p>Then it results in <code>&quot;something else&quot;</code></p>");
    _builder.newLine();
    _builder.append("</span>");
    _builder.newLine();
    _builder.append("</li>");
